...
<div class="wrapper">
	...
	<div class="main main-raised">
		...
		<input id="password" type="password" name="pass1" class="form-control">
	</div>
</div>
		<div class="col-sm-5">
		<div class="form-group label-floating">
		<label for="password"class="validate">Masukan Password Kembali</label>
		<input id="password" type="password" name="pass2" class="form-control">
		</div>
	</div>
</div>
